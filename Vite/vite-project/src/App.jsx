...
import MessagesComponent from './components/MessagesComponent'; // Importar el nuevo componente
import './App.css';
    ...
    <div>
      ...
      {user ? (
        <div>
          ...
          {/* Mostrar los componentes si el usuario está autenticado */}
          <Crud />
          <DataComponent />
          <MessagesComponent /> {/* Agregar el nuevo componente */}
        </div>
      ) : (
        <div>
